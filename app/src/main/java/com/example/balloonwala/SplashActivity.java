...
public class SplashActivity extends AppCompatActivity {
    ...
    private final Runnable navigateAction = () -> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(navigateAction, SPLASH_DELAY_MS);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        // Cancel pending navigation if user presses Back during splash
        handler.removeCallbacks(navigateAction);
    }
}
