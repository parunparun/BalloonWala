...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void calculateCenterAndBounds(Context context, Rect anchorRect, View anchorView) {
        ...
        if (i == 8388691 || i == 8388693) {
            this.badgeCenterY = anchorRect.bottom - this.savedState.verticalOffset;
        } else {
            this.badgeCenterY = anchorRect.top + this.savedState.verticalOffset;
        }
        if (getNumber() <= 9) {
        ...
        if (i2 == 8388659 || i2 == 8388691) {
            this.badgeCenterX = ViewCompat.getLayoutDirection(anchorView) == 0 ? (anchorRect.left - this.halfBadgeWidth) + inset + this.savedState.horizontalOffset : ((anchorRect.right + this.halfBadgeWidth) - inset) - this.savedState.horizontalOffset;
        } else {
            this.badgeCenterX = ViewCompat.getLayoutDirection(anchorView) == 0 ? ((anchorRect.right + this.halfBadgeWidth) - inset) - this.savedState.horizontalOffset : (anchorRect.left - this.halfBadgeWidth) + inset + this.savedState.horizontalOffset;
        }
    }
