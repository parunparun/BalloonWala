...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private final Runnable bottomMarginGestureInsetRunnable = new Runnable() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.2
        ...
        public void run() {
            int currentInsetBottom = BaseTransientBottomBar.this.getScreenHeight() - BaseTransientBottomBar.this.getViewAbsoluteBottom();
    ...
    public B setAnchorView(int anchorViewId) {
        View viewFindViewById = this.targetParent.findViewById(anchorViewId);
