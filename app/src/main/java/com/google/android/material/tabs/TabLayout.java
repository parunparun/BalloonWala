...
public class TabLayout extends HorizontalScrollView {
    ...
    protected OnTabSelectedListener wrapOnTabSelectedListener(final BaseOnTabSelectedListener baseListener) {
        ...
        OnTabSelectedListener listener = new OnTabSelectedListener() { // from class: com.google.android.material.tabs.TabLayout.1
        ...
        this.selectedListenerMap.put(baseListener, listener);
        return listener;
    }
    ...
    */
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
            ...
            event.setClassName(TabLayout.ACCESSIBILITY_CLASS_NAME);
        }

        @Override // android.view.View
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            super.onInitializeAccessibilityNodeInfo(info);
            info.setClassName(TabLayout.ACCESSIBILITY_CLASS_NAME);
