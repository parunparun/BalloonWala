...
public class ReflectionToStringBuilder extends ToStringBuilder {
    ...
    protected void appendFieldsIn(Class<?> clazz) {
        ...
        Arrays.sort(fields, Comparator.comparing(new Function() { // from class: org.apache.commons.lang3.builder.-$$Lambda$ReflectionToStringBuilder$EwHr87MK7hEsolm9oeBYC5WlLmc
