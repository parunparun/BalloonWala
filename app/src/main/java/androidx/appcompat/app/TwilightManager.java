...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        calculator.calculateTwilight(now - DateUtils.MILLIS_PER_DAY, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(DateUtils.MILLIS_PER_DAY + now, location.getLatitude(), location.getLongitude());
        ...
        if (todaySunrise == -1 || todaySunset == -1) {
            ...
            nextUpdate = nextUpdate2 + DateUtils.MILLIS_PER_MINUTE;
        }
