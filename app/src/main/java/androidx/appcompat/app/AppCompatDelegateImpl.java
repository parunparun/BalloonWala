...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public void attachBaseContext(Context context) throws IllegalAccessException {
        applyDayNight(false);
        this.mBaseContextAttached = true;
    }

    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onCreate(Bundle savedInstanceState) throws IllegalAccessException {
        this.mBaseContextAttached = true;
        applyDayNight(false);
        ensureWindow();
    ...
    public boolean hasWindowFeature(int featureId) {
        ...
        int iSanitizeWindowFeatureId = sanitizeWindowFeatureId(featureId);
        ...
        } else if (iSanitizeWindowFeatureId == 109) {
    ...
    public ActionMode startSupportActionMode(ActionMode.Callback callback) {
        ...
        ActionBar ab = getSupportActionBar();
        if (ab != null) {
            ActionMode actionModeStartActionMode = ab.startActionMode(wrappedCallback);
    ...
    private boolean applyDayNight(boolean allowRecreation) throws IllegalAccessException {
        if (this.mIsDestroyed) {
            return false;
        }
    ...
    private boolean updateForNightMode(int mode, boolean allowRecreation) throws IllegalAccessException {
        int newNightMode;
        boolean handled = false;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void updateResourcesConfigurationForNightMode(int uiModeNightModeValue, boolean callOnConfigChange) throws IllegalAccessException {
