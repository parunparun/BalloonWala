...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /* JADX WARN: Type inference failed for: r22v0, types: [androidx.recyclerview.widget.StaggeredGridLayoutManager] */
            ...
            if (layoutState.hasMore(state)) {
                ...
                if (layoutState.mLayoutDirection == r10) {
                    if (layoutParams.mFullSpan) {
                        decoratedMeasurement2 = getMaxEnd(i2);
                    } else {
                        decoratedMeasurement2 = span.getEndLine(i2);
                    }
                    ...
                    if (layoutParams.mFullSpan) {
                        startLine = getMinStart(i2);
                    } else {
                        startLine = span.getStartLine(i2);
                    }
                ...
                if (isLayoutRTL() && this.mOrientation == r10) {
                    ...
                    decoratedMeasurement3 = this.mSecondaryOrientation.getDecoratedMeasurement(next) + i5;
                    decoratedMeasurement4 = i5;
                }
                if (this.mOrientation == r10) {
                    span2 = span;
                    layoutDecoratedWithMargins(next, decoratedMeasurement4, i3, decoratedMeasurement3, i4);
                } else {
                    span2 = span;
                    layoutDecoratedWithMargins(next, i3, decoratedMeasurement4, i4, decoratedMeasurement3);
                }
                if (layoutParams.mFullSpan) {
