...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:130:0x0277 A[RETURN] */
    ...
    */
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        int i4 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintWidget$DimensionBehaviour[dimensionBehaviour.ordinal()];
        if (i4 == 1 || i4 == 2 || i4 == 3) {
            variableSize = false;
        } else if (i4 != 4) {
            variableSize = false;
        ...
        if (applyPosition) {
            if (!isBeginConnected && !isEndConnected && !isCenterConnected) {
                ...
                system.addEquality(begin2, beginTarget3, beginAnchor.getMargin(), 6);
            }
        }
        if (!variableSize2) {
            if (wrapContent) {
                system.addEquality(end2, begin2, 0, 3);
                if (minDimension <= 0) {
                    i3 = 6;
                } else {
                    i3 = 6;
                    system.addGreaterThan(end2, begin2, minDimension, 6);
                }
                if (maxDimension < Integer.MAX_VALUE) {
                    system.addLowerThan(end2, begin2, maxDimension, i3);
                }
            } else {
                system.addEquality(end2, begin2, dimension2, 6);
            }
            ...
            if (matchMinDimension3 <= 0) {
                ...
                i = 6;
                system.addGreaterThan(end2, begin2, matchMinDimension3, 6);
                dimension2 = Math.max(dimension2, matchMinDimension3);
            }
            if (matchMaxDimension3 > 0) {
                system.addLowerThan(end2, begin2, matchMaxDimension3, i);
            ...
            if (matchConstraintDefault2 == 1) {
                if (parentWrapContent) {
                    ...
                    system.addEquality(end2, begin2, dimension2, 4);
                    dimension3 = dimension2;
                    matchConstraintDefault3 = matchConstraintDefault2;
                    matchMinDimension2 = matchMinDimension3;
                    matchMaxDimension2 = matchMaxDimension3;
                    ...
                    system.addEquality(end2, begin2, dimension2, 1);
                    dimension3 = dimension2;
                    matchConstraintDefault3 = matchConstraintDefault2;
                    matchMinDimension2 = matchMinDimension3;
                    matchMaxDimension2 = matchMaxDimension3;
                ...
                endTarget = endTarget2;
                beginTarget = beginTarget3;
                system.addConstraint(system.createRow().createRowDimensionRatio(end2, begin2, percentEnd2, percentEnd, matchPercentDimension));
                variableSize2 = false;
            }
            if (variableSize2 && numConnections != 2 && !useRatio) {
                ...
                system.addEquality(end2, begin2, d, 6);
            }
        }
        if (!applyPosition || inChain) {
            SolverVariable begin3 = begin2;
            int i5 = 6;
            int matchMinDimension4 = numConnections;
            if (matchMinDimension4 < 2 && parentWrapContent) {
                system.addGreaterThan(begin3, parentMin, 0, i5);
                system.addGreaterThan(parentMax, end2, 0, i5);
                return;
            }
            return;
        }
            ...
            if (isBeginConnected && !isEndConnected) {
                ...
                if (!variableSize2) {
                    ...
                    if (parentWrapContent && minDimension == 0) {
                        system.addGreaterThan(end2, begin2, 0, 6);
                    }
                    matchConstraintDefault5 = matchConstraintDefault3;
                    if (matchConstraintDefault5 == 0) {
                        ...
                        beginTarget2 = beginTarget;
                        system.addEquality(begin2, beginTarget2, beginAnchor.getMargin(), strength);
                        ...
                        if (matchConstraintDefault5 == 1) {
                            ...
                            system.addEquality(begin2, beginTarget2, beginAnchor.getMargin(), strength2);
                ...
                if (applyCentering) {
                    ...
                    begin = begin2;
                    system.addCentering(begin2, beginTarget2, beginAnchor.getMargin(), bias, endTarget, end2, endAnchor.getMargin(), centeringStrength);
                ...
                if ((!variableSize2 && applyStartConstraint) || applyBoundsCheck) {
                    system.addGreaterThan(begin, beginTarget2, beginAnchor.getMargin(), startStrength);
                }
                ...
                if (!parentWrapContent) {
                    ...
                    i2 = 0;
                    system.addGreaterThan(begin, parentMin, 0, matchConstraintDefault4);
                }
            } else {
                matchConstraintDefault4 = 6;
            }
        ...
        if (parentWrapContent) {
            system.addGreaterThan(parentMax, end2, i2, matchConstraintDefault4);
        }
    }
