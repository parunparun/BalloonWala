...
public class Optimizer {
    ...
    */
    static boolean applyChainOptimized(androidx.constraintlayout.solver.widgets.ConstraintWidgetContainer r40, androidx.constraintlayout.solver.LinearSystem r41, int r42, int r43, androidx.constraintlayout.solver.widgets.ChainHead r44) {
        /*
