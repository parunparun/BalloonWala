            ...
            if (action2 != 1) {
                if (action2 != 2) {
                        ...
                        if (action2 == 5) {
                            ...
                            if (i2 == 0) {
                                ...
                                if ((edgesTouched2 & i3) != 0) {
                                    this.mCallback.onEdgeTouched(i3 & edgesTouched2, pointerId2);
                                }
                            } else {
                                if (i2 == 2 && (toCapture = findTopChildUnder((int) x2, (int) y2)) == this.mCapturedView) {
                                    tryCaptureViewForDrag(toCapture, pointerId2);
                                }
                                z = false;
                            }
                            z = false;
                    ...
                    while (i4 < pointerCount2) {
                        int pointerId3 = ev.getPointerId(i4);
                        if (isValidPointerForActionMove(pointerId3)) {
                            float x3 = ev.getX(i4);
                            float y3 = ev.getY(i4);
                            float dx = x3 - this.mInitialMotionX[pointerId3];
                            float dy = y3 - this.mInitialMotionY[pointerId3];
                            View toCapture3 = findTopChildUnder((int) x3, (int) y3);
                            boolean pastSlop = (toCapture3 == null || !checkTouchSlop(toCapture3, dx, dy)) ? false : z2;
                            if (!pastSlop) {
                                action = action2;
                                ...
                                pointerCount = pointerCount2;
                                int pointerCount3 = (int) dy;
                                int newTop = this.mCallback.clampViewPositionVertical(toCapture3, targetTop, pointerCount3);
                            ...
                            reportNewEdgeDrags(dx, dy, pointerId3);
                            if (this.mDragState == 1 || (pastSlop && tryCaptureViewForDrag(toCapture3, pointerId3))) {
                                break;
                            }
                        } else {
                            action = action2;
            ...
            if (this.mDragState == 1 && pointerId4 == this.mActivePointerId) {
                ...
                while (true) {
                    ...
                    if (id != this.mActivePointerId) {
                        View viewFindTopChildUnder = findTopChildUnder((int) ev.getX(i5), (int) ev.getY(i5));
                        View view = this.mCapturedView;
                        if (viewFindTopChildUnder == view && tryCaptureViewForDrag(view, id)) {
