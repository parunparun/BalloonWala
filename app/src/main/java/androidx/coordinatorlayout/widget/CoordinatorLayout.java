...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public void setStatusBarBackground(Drawable bg) {
        ...
        if (drawable != bg) {
            ...
            Drawable drawableMutate = bg != null ? bg.mutate() : null;
    ...
    */
    ...
    static Behavior parseBehavior(Context context, AttributeSet attrs, String name) {
        ...
        if (name.startsWith(".")) {
            ...
            fullName = WIDGET_PACKAGE_NAME + ClassUtils.PACKAGE_SEPARATOR_CHAR + name;
        } else {
            fullName = name;
        }
        try {
    ...
    */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            boolean zHasValue = a.hasValue(R.styleable.CoordinatorLayout_Layout_layout_behavior);
        ...
        boolean isBlockingInteractionBelow(CoordinatorLayout parent, View child) {
            ...
            Behavior behavior = this.mBehavior;
            boolean zBlocksInteractionBelow = z | (behavior != null ? behavior.blocksInteractionBelow(parent, child) : false);
        ...
        private void resolveAnchorView(View forChild, CoordinatorLayout parent) {
            View viewFindViewById = parent.findViewById(this.mAnchorId);
            this.mAnchorView = viewFindViewById;
            if (viewFindViewById != null) {
                if (viewFindViewById == parent) {
                ...
                for (ViewParent p = viewFindViewById.getParent(); p != parent && p != null; p = p.getParent()) {
                    if (p == forChild) {
                        if (parent.isInEditMode()) {
                            this.mAnchorDirectChild = null;
                            this.mAnchorView = null;
